...
** [[file:batch-telemetry/README.md][batch-telemetry]]

Server-side batch telemetry for PostgreSQL 15, 16, or 17. Diagnoses batch job performance variance ("Why did this batch take 60 minutes instead of 10?"). Automatically collects metrics via ~pg_cron~ including WAL, checkpoints, wait events, lock contention, and more.
...
|------+------------+------------+-------|
| batch-telemetry | 15, 16, 17 | pg_cron 1.4.1+ | - |
